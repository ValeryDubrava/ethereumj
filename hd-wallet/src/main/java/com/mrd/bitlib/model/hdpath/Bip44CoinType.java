...
public class Bip44CoinType extends Bip44Purpose  {
    public Bip44CoinType(Bip44Purpose parent, Long index, boolean hardened) {
        super(parent, index, hardened);
    }

    public Bip44Account getAccount(Long id){
        return new Bip44Account(this, id, true);
    }
    public Bip44Account getAccount(int id){
        return new Bip44Account(this, Long.valueOf(id), true);
    }
